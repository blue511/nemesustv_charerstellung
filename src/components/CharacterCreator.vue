  ...
  <div class="charactercreator">
    <body>
      <div class="wrapper d-flex align-items-stretch">
        <div id="sidebar" ref="sidebar" class="active animate__animated animate__backInUp" style="overflow-x:hidden;overflow-y:hidden;">
          <div class="p-4">
            <h1><a class="logo">Charakter Erstellung AltV</a></h1>
            <ul id="navigation" class="list-unstyled components mb-5">
              <li :class="[(naviSwitch == 'Indentität') ? 'active':'']">
                <a @click="naviSwitch='Indentität'" style="cursor:pointer"><span class="fa fa-home mr-3"></span>Identität</a>
              </li>
              ...
              <li :class="[(naviSwitch == 'Haare') ? 'active':'']">
                <a @click="naviSwitch='Haare'" style="cursor:pointer"><span class="fa fa-user-edit mr-3"></span>Haare/Bart</a>
              </li>
              ...
              <li :class="[(naviSwitch == 'Details') ? 'active':'']">
                <a @click="naviSwitch='Details'" style="cursor:pointer"><span class="fa fa-info-circle mr-3"></span>Details</a>
              </li>
              <li :class="[(naviSwitch == 'Kleidung') ? 'active':'']">
                <a @click="naviSwitch='Kleidung'" style="cursor:pointer"><span class="fa fa-tshirt mr-3"></span>Kleidung</a>
              </li>
              <li :class="[(naviSwitch == 'Fertig') ? 'active':'']">
                <a @click="naviSwitch='Fertig'" style="cursor:pointer"><span class="fa fa-flag-checkered mr-3"></span>Fertig</a>
              </li>
            </ul>
            <div class="footer">
        ...
        <div id="box" class="ml-1 mt-1 animate__animated animate__backInUp"
          ...
          <span class="ml-1"></span>Kameraauswahl:<input class="ml-3 slider" type="range" min="1" max="100" value="1" data-orientation="vertical">
        </div>
          ...
          <ul class="list-unstyled components mb-5">
            <li class="active">
              ...
              <div v-if="character.gender == 'Männlich'">
                <button type="button" class="btn btn-primary" style="background-color: #104e6b; border: 0" v-on:click="character.gender = 'Männlich'; reRender()">Männlich</button>
                <button type="button" class="btn btn-secondary ml-2" v-on:click="character.gender = 'Weiblich'">Weiblich</button>
              </div>
              <div v-if="character.gender == 'Weiblich'">
                <button type="button" class="btn btn-secondary" v-on:click="character.gender = 'Männlich'">Männlich</button>
                <button type="button" class="btn btn-primary ml-2" style="background-color: #104e6b; border: 0" v-on:click="character.gender = 'Weiblich'; reRender()">Weiblich</button>
              </div>
            </li>
            <li class="active">
          ...
          <ul class="list-unstyled components mb-5">
            <li class="active mt-2" v-for="(blend, index) in blendData" :key="index">
              ...
              <input class="ml-2 slider" type="range" :min="blend[1]" :max="blend[2]" value='0' :step="blend[3]"
                v-model="character.blendData[index]"><small class="ml-2">{{character.blendData[index]}}</small>
            </li>
            <div class="mt-2">
              <span class="contenttext">Augenfarbe</span>
                <div class="hair">
                              <ul class="hairColors-1">
                    <li v-for="hairColor in hairColors" :key="hairColor" :style="{ background: hairColor }">
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <ul class="list-unstyled components mb-5">
            <li class="active mt-2" v-for="(faceFeature, index) in faceFeatures" :key="index">
              ...
              <input class="ml-2 slider" type="range" :min="-1" :max="1" :step="0.1"
                v-model="character.faceFeatures[index]"><small class="ml-2">{{character.faceFeatures[index]}}</small>
            </li>
          </ul>
        </div>
          ...
          <ul class="list-unstyled components mb-5">
            <li class="active mt-2" v-for="(headOverlay, index) in headOverlays" :key="index">
              <span class="contenttext">{{headOverlays[index]}}</span><span class="ml-2 fa fa-window-close icons"
                :key="index+1" v-on:click="character.headOverlays[index] = 255; character.headOverlaysColors[index] = 0; reRender();"
                style="color:lightred;cursor: pointer"></span>
              <input class="ml-2 slider" type="range" :min="0" :max="headOverlaysMax[index]" :step="1"
                v-model="character.headOverlays[index]"><small class="ml-2">{{character.headOverlays[index]}}</small>
          ...
          <ul class="list-unstyled components mb-5">
            <li class="active mt-2" v-for="(clothing, index) in clothings" :key="index">
              ...
              <input class="ml-2 slider" type="range" :min="0" :max="clothingMax[index]" :step="1"
                v-model="character.clothing[index]"><small class="ml-2">{{character.clothing[index]}}</small>
            </li>
          </ul>
        </div>
        <div v-if="!naviSwitch" id="sidebar" class="p-4 animate__animated animate__backInUp"
          ...
          <p class="mt-2">Willkommen auf dem <strong>NemesusTV Tutorial (Powered by Nemesus.de)</strong> Roleplayserver.
           Du kannst dir jetzt einen Charakter erstellen, wähle dazu links eine Kategorie aus.</p>
        ...
        <div v-if="naviSwitch == 'Fertig'" id="sidebar" class="p-4"
          ...
          <p class="mt-2">Bitte beachte, wir sind ein <strong>Roleplay-Server</strong> demzufolge schlüpfst du in die
            Rolle eines Charakteres und spielst diesen aus. Für einen reibungslosen Spielverlauf gibt es Regeln, diese
            findest du unter <strong>https://regeln.nemesus.de</strong>, bitte lese dir diese aufmerksam durch!</p>
          <p>Nach dem Klicken von 'Charakter erstellen' wird dein Charakter erstellt, dann beginnt dein IC Leben!</p>
          <button type="button" class="btn btn-success mt-5 ml-4 animate__animated animate__heartBeat">Charakter erstellen</button>
        </div>
        <div v-if="naviSwitch == 'Haare'" id="sidebar" class="p-4"
          ...
          <ul class="list-unstyled components mb-5">
            <li>
              ...
              <input class="ml-3 slider" type="range" min="0" max="75" value="1" v-model="character.hair[0]"><small
                class="ml-2">{{character.hair[0]}}</small>
              <hr />
            </li>
            <li>
            ...
            <li>
              ...
              <input class="ml-3 slider" type="range" min="1" max="28" value="1" v-model="character.beard[0]"><small
                class="ml-2">{{character.beard[0]}}</small>
              <hr />
            </li>
            <li>
...
export default {
  ...
  watch: {
      hair: function () {
        this.customize('hair', 1, this.hair);
...
#sidebar {
  ...
  overflow-y: auto;
  overflow-x: hidden;
  background: -webkit-linear-gradient(top, #0074e0, #07a9d6);
  color: #fff;
...
.btn.btn-primary {
  background: rgb(16, 78, 107);
  border-color: rgb(16, 78, 107);
}

.btn.btn-primary:hover,
.btn.btn-primary:focus {
  background: rgb(25, 92, 126) !important;
  border-color: rgb(25, 78, 107) !important;
}
